...
#define LOG_TRACE(...) lima::Logger::log(lima::LogType::Trace, __VA_ARGS__)
#define LOG_DEBUG(...) lima::Logger::log(lima::LogType::Debug, __VA_ARGS__)
#define LOG_INFO(...) lima::Logger::log(lima::LogType::Info, __VA_ARGS__)
#define LOG_WARNING(...) lima::Logger::log(lima::LogType::Warning, __VA_ARGS__)
#define LOG_ERROR(...) lima::Logger::log(lima::LogType::Error, __VA_ARGS__)
#define LOG_FATAL(...) lima::Logger::log(lima::LogType::Fatal, __VA_ARGS__)

#define LIMA_SET_OUTPUT_STREAM(...) lima::Logger::setOutputStream(__VA_ARGS__)
#define LIMA_SET_FLAG(...) lima::Logger::setFlag(__VA_ARGS__)
#define LIMA_CLEAR_FLAG(...) lima::Logger::clearFlag(__VA_ARGS__)
#define LIMA_SET_FILTER(...) lima::Logger::setFilter(__VA_ARGS__)
#define LIMA_CLEAR_FILTER(...) lima::Logger::clearFilter(__VA_ARGS__)
...
namespace lima {
    ...
    inline std::ostream& operator<<(std::ostream& p_ostream, LogType p_logType) { return p_ostream; }
    ...
    inline std::string str(LogTag p_logTag) { return "[" + p_logTag.getName() + "]"; }

    inline std::ostream& operator<<(std::ostream& p_ostream, LogTag p_logTag) { return p_ostream; }
